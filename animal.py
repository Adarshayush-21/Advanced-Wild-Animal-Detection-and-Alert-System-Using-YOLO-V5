...
TO_EMAIL = "adarsh02354@gmail.com"  # Replace with recipient's email
...
st.title("Wild Animal Detection System⚠️")
...
def detect_human_and_animal(frame):
    ...
    for info in result:
        ...
        for box in boxes:
            ...
            # Detect human with a lower threshold (confidence > 40%)
            if confidence > 40 and classnames[class_index] == human_class:
            ...
            # Detect wild animals (with confidence > 80%)
            elif confidence > 80 and classnames[class_index] in wild_animals:
